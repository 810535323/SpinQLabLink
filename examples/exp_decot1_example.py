...
def main():
    ...
    for width in width_list:
        ...
        exp_decot1_para.freq_h = 37.852105  # Hydrogen resonance frequency (MHz)
        exp_decot1_para.freq_p = 15.322872  # Phosphorus resonance frequency (MHz)
        exp_decot1_para.makePps = True  # Generate PPS signal
        exp_decot1_para.samplePath = 0  # Sampling path: 0=Hydrogen channel, 1=Phosphorus channel
        exp_decot1_para.custom_freq = False  # Use custom frequency (true: use custom freq_h and freq_p, false: use device's lock field frequency)
